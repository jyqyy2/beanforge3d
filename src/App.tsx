  ...
  return (
    <div className="site">
      ...
      <main>
        <section className="hero">
          <div className="hero-content">
            <p className="eyebrow">3D PRINTED • CUSTOM • MADE WITH CARE</p>
            ...
            <p className="hero-text">
              3D printed goods, custom gifts and useful little creations
              designed to make everyday things a little more fun.
            </p>
        ...
        <section className="categories" id="shop">
          ...
          <div className="category-grid">
            <a href="#keycaps" className="category-card">
              <span>01</span>
              <h3>Keycaps</h3>
              <p>Give your keyboard a little personality.</p>
            </a>

            <a href="#skadis" className="category-card">
              <span>02</span>
              <h3>SKÅDIS</h3>
              <p>Modular accessories for a tidier space.</p>
            </a>

            <a href="#qr-nfc" className="category-card">
              <span>03</span>
              <h3>QR / NFC</h3>
              <p>Useful stands and displays for businesses.</p>
            </a>

            <a href="#custom" className="category-card">
              <span>04</span>
              <h3>Custom</h3>
              <p>Made-to-order pieces made for you.</p>
            </a>
          </div>
        </section>
          ...
          <div className="product-grid">
            <article className="product-card">
              ...
              <div className="product-info">
                <div>
                  <h3>Bean Keycap</h3>
                  <p>For keyboards that need a little bean.</p>
                </div>
            ...
            <article className="product-card">
              ...
              <div className="product-info">
                <div>
                  ...
                  <p>Your name. Your colour. Your way.</p>
                </div>
        ...
        <section className="custom-section" id="custom">
          <div className="custom-content">
            ...
            <p>
              A birthday gift. A desk accessory. A name tag. A clicker for
              your work-from-home friend. Tell us what you're thinking and
              we'll see what we can make.
            </p>
            <a className="button button-light" href="#custom-request">
        ...
        <section className="corporate-section" id="corporate">
          <div className="corporate-content">
            <div>
              ...
              <h2>Made for teams, events &amp; clients.</h2>
            </div>

            <div>
              <p>
                Custom-coloured accessories, name tags, QR stands, onboarding
                kits and corporate gifts — made to your specifications.
              </p>
              <a className="text-link" href="#corporate-request">
                Talk to us →
              </a>
            </div>
          </div>
      ...
      <footer className="footer" id="about">
        ...
        <p className="copyright">© 2026 BeanForge 3D</p>
      </footer>
    </div>
  )
}
